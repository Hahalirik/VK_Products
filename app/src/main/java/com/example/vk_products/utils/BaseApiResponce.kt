package com.example.vk_products.utils
...
abstract class BaseApiResponse {
    ...
    private fun <T> errorMessage(e: String): NetworkResult.Error<T> = NetworkResult.Error(data = null, message = "Api call failed: $e")
